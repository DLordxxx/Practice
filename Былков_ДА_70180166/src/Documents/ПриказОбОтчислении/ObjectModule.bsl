...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
    ...
    Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ПротоколЗаседанияКомиссии") Тогда 
        ...
        ЭтотОбъект.КоличествоЛиквидированныхЗадолженностей = Выборка.КоличествоЛиквидированныхЗадолженностей;
        ...
        Иначе
            ...
            ВызватьИсключение "Студент имеет " + Выборка.ПроцентЗадолженностей + 
                            "% академических задолженностей! Ввод документа «Приказ об отчислении» " +
...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Движение.КоличествоПросроченныхЗадолженностейДляОтчисления = КоличествоЛиквидированныхЗадолженностей;
