...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
    ...
    Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.РекомендацииПоСтудентам") Тогда
        ...
        КоличествоВозникших = ПолучитьКоличествоЗадолженностей(ДокументОснование.Студент);
...
&НаСервере
Функция ПолучитьКоличествоЗадолженностей(Студент)
    ...
    Запрос.Текст = 
    "ВЫБРАТЬ
    |    КОЛИЧЕСТВО(Идентификация.Ссылка) КАК Количество
    |ИЗ
    |    Документ.ИдентификацияАкадемическихЗадолженностей КАК Идентификация
    |ГДЕ
    |    Идентификация.Студент = &Студент";
    ...
    Возврат КоличествоЗадолженностей;
КонецФункции
...
Функция ПолучитьКоличествоЛиквидированныхЗадолженностей(Студент)
    ...
    Возврат КоличествоЛиквидированных;
КонецФункции