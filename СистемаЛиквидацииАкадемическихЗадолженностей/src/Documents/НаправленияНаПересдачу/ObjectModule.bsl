...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	// Данный фрагмент построен конструктором.
	// При повторном использовании конструктора, внесенные вручную изменения будут утеряны!!!
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ИндетификацияАкадемическихЗадолженностей") Тогда
		// Заполнение шапки
...
Процедура СоздатьПриказИзНаправлений() Экспорт
    ...
    НовыйПриказ = Документы.ПриказыОНазначенииКомиссииПоЛиквидацииЗадолженностей.СоздатьДокумент();
    ...
    ВыборкаНаправлений = Документы.НаправленияНаПересдачу.Выбрать();
